    ...
    <form>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5">
                        <input id="userBd" type="text" class="form-control" placeholder="Minuto" v-model="backup.userBd">
                        
                    </div>
                    <div class="form-group col-md-5">
                        <input id="passwordBd" type="" class="form-control" placeholder="Hora" v-model="backup.passwordBd">
        ...
        <div class="row">
            <div class="col-md-6" style="padding=0.5em;">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">Descripcion del cron</h2>
            ...
            <div class="col-md-6">
                <div class="card"> 
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label  class="col-form-label">Día Mes</label>
...
methods: {
    registrar(){
        API.post("http://localhost:8086/api/v1/settings-crear",{
        name:this.backup.nameBd+this.backup.dateb,
        nameBd:this.backup.nameBd,
